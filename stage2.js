...
function setup(){
	...
	platforms.push( ground=new Platform(width/2,height,width,40));
 	...
 	platforms.push(new Platform(300,500,100,15));
 	platforms.push(new Platform(450,420,100,15));
 	platforms.push(new Platform(600,350,100,15));
 	platforms.push(new Platform(750,440,100,15));
