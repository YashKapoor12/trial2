...
function setup(){
	...
	platforms.push( ground=new Platform(width/2,height,width,40));
 	platforms.push(new Platform(100,675,200,300,))

 	platforms.push(new Platform(300,400,100,15));
 	platforms.push(new Platform(450,490,100,15));
 	platforms.push(new Platform(600,390,100,15));
 	platforms.push(new Platform(750,250,100,15));
 	platforms.push(new Platform(900,320,100,15));
}
